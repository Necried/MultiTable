...
void test_rand_doubles(unsigned int seed, int ontests, __uint64_t *T_Table,
  ...
  printf("\n===================================================\n");
  printf("SQRT DOUBLE PRECISION LOG REPORT:\n");
  printf("Results for sqrt double precision recorded in:\n\tlog/sqrt_dp.log\n");
...
int main() {
  ...
  fprintf(fptr, "Testing sqrt table : %d bits table, size %d \n", fracBitsTable,
         SQRT_TABLE_SIZE);
