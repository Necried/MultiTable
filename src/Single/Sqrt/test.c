...
// go throught table fromtable to tableend
  ...
  printf("\n===================================================\n");
  printf("SQRT SINGLE PRECISION LOG REPORT:\n");
  printf("Results for sqrt single precision recorded in:\n\tlog/sqrt_sp.log\n");
...
int main(int argc, const char *argv[]) {
  ...
  test(0, 0, SQRT_TABLE_SIZE - 1, T_Table, S_Table, A_Table, fptr);
